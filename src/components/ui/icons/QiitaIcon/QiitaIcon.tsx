...
export type qiitaIconProps = ComponentPropsWithRef<'svg'>;

export type presentialQiitaIconProps = qiitaIconProps;

export const PresentialQiitaIcon: FC<presentialQiitaIconProps> = (props) => {
  return (
    <>
      <svg
        version="1.2"
...
export const QiitaIcon: FC<qiitaIconProps> = (props) => {
  return <PresentialQiitaIcon {...props} />;
};
